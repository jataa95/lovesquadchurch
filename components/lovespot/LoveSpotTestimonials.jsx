...
export default function LoveSpotTestimonials() {
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              ...
              <div
                ...
                "
              >
                <div className="lovespot-marquee-track">
                  <div
                    className="
                      shrink-0
                      whitespace-nowrap
      ...
      <style jsx>{`
        .lovespot-marquee-track {
          display: flex;
          width: max-content;
          animation: lovespotMarquee 14s linear infinite;
          will-change: transform;
        }

        @keyframes lovespotMarquee {
          from {
